...
@section('content')
    ...
    <div class="container" style="background-color: white">
        <h1 class="header">TRACER STUDI</h1>
        ...
        <div class="section">
            ...
            <div class="column">
                <label for="filePasFoto">Upload Pas Foto / Selfie :</label> 
                <input type="file" id="filePasFoto" name="filePasFoto">
            </div>

            <div class="column">
                <label for="fileKtp">Upload Pas Foto / Selfie :</label>
                <input type="file" id="fileKtp" name="fileKtp">
            </div>

            <div class="column">
                <label for="fileIjazah">Upload Pas Foto / Selfie :</label>
