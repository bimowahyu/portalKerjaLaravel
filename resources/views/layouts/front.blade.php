        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>himasoft mplb</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>081241212648</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>misterhilma@gmail.com</small>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                @if (empty(session('role_id')))
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="{{ url('/loginpencariankerja') }}" class="nav-item nav-link">TRACER STUDI</a>
                ...
                @else
                    ...
                    @if (session('role_id') == 3)
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <a href="{{ route('users.ak1') }}" class="nav-item nav-link">TRACER STUDI</a>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="text-white mb-md-4 animated zoomIn">Bursa Kerja Khusus (BKK)</h1>
                            <h1 class="text-white mb-md-4 animated zoomIn">& TRACER STUDI</h1>
                            <h2 class=" text-white mb-md-4 animated zoomIn">SMKN 9 SEMARANG</h2>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">hilmasoft mplb</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">misterhilma@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-primary me-2"></i>
                                <p class="mb-0">081241212648</p>
                            </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">hilmasoft</a>. All Rights Reserved.

                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                            Designed by <a class="text-white border-bottom" href="">HTML
                                hilmasoft   .</a>
                        </p>
                        Distributed By: <a class="border-bottom" href=""
                            target="_blank">hilmasoft</a>
                    </div>
                </div>
            </div>
        </div>
