...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
          ...
          <span class="input-group-btn">
                ...
                @if (session('role_id') == 3)
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li><a href="{{ route('users.ak1') }}"><i class="fa fa-book"></i> <span>TRACER STUDI</span></a></li>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2016 <a href="https://adminlte.io">hilmasoft</a>.</strong> All rights
            reserved. | Repost by <a href='' title='' target='_blank'>hilmasoft</a>
        </footer>
