    ...
    <form action="{{ route('users.simpan-ak1') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <b>
                    <p style="font-size: 20px">TRACER STUDI</p>
                </b>
            </div>
            @php
            ...
            @if ($modPembuatanAk1)
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Jurusan saat di SMK</label>
                    ...
                    <div class="form-group">
                        <label>Nama Univ (Jika Kuliah)</label>
                    ...
                    <div class="form-group">
                        <label for="pendidikan_terakhir">Status Kesibukan:</label>
                        <select name="pendidikan_terakhir" class="form-control select2" required>
                            <option value="SD" {{ $modPembuatanAk1->pendidikan_terakhir == 'SD' ? 'selected' : '' }}>KULIAH
                            </option>
                            <option value="SMP" {{ $modPembuatanAk1->pendidikan_terakhir == 'SMP' ? 'selected' : '' }}>
                                KERJA</option>
                            <option value="SMK/SMA"
                                {{ $modPembuatanAk1->pendidikan_terakhir == 'SMK/SMA' ? 'selected' : '' }}>WIRAUSAHA</option>
                            <option value="KULIAH"
                                {{ $modPembuatanAk1->pendidikan_terakhir == 'KULIAH' ? 'selected' : '' }}>DIRUMAH</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Nama Perusahaan (Jika bekerja)</label>
                    ...
                    <div class="form-group">
                        <label for="foto">Upload Pas Foto / Selfie</label>
                    ...
                    <div class="form-group">
                        <label for="ktp">Upload Pas Foto / Selfie</label>
                    ...
                    <div class="form-group">
                        <label for="ijazah">Upload Pas Foto / Selfie</label>
            ...
            @else
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="pendidikan_terakhir" class="form-control select2" required>
                            <option value="" selected disabled>--Pilih--</option>
                            <option value="SD">KULIAH</option>
                            <option value="SMP">KERJA</option>
                            <option value="SMK/SMA">WIRAUSAHA</option>
                            <option value="KULIAH">DIRUMAH</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Nama Perusahaan (Jika bekerja)</label>
